...
class TestPreParserWarnings(unittest.TestCase):
    ...
    def test_warn_about_unrecognized_option(self):
        ...
        self.assertTrue(any("unrecognized option '--unknown'" in str(warning.message) for warning in warnings_caught))
    ...
    def test_warn_about_invalid_option(self):
        ...
        warnings_caught = self.parse_with_warning(optdict, query)
        self.assertTrue(any("invalid option -- 'z'" in str(warning.message) for warning in warnings_caught))
    ...
    def test_warn_about_invalid_combined_options(self):
        ...
        warnings_caught = self.parse_with_warning(optdict, query)
        self.assertTrue(any("invalid option -- 'x'" in str(warning.message) for warning in warnings_caught))
    ...
    def test_warn_about_ambiguous_option(self):
        ...
        warnings_caught = self.parse_with_warning(optdict, query)
        self.assertTrue(any("option '--fo' is ambiguous; possibilities: '--foo' '--foobar' '--foxtrot'" in str(warning.message) for warning in warnings_caught))
    ...
    def test_warn_about_unallowed_argument(self):
        ...
        warnings_caught = self.parse_with_warning(optdict, query)
        self.assertTrue(any("option '--flag' doesn't allow an argument" in str(warning.message) for warning in warnings_caught))
    ...
    def test_warn_about_required_argument(self):
        ...
        warnings_caught = self.parse_with_warning(optdict, query)
        self.assertTrue(any("option requires an argument -- '--foo'" in str(warning.message) for warning in warnings_caught))
