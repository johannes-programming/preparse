...
from preparse._parsing.Parsing import Parsing
...
class PreParser:
    def __init__(
        ...
        permutate: Any = True,
        posix: Any = "infer",
        shortOptionAbbreviations: Any = ShortOptionClusters.MAINTAIN,
    ) -> None:
        self._optdict = dict()
        ...
        self.posix = posix
        self.shortOptionAbbreviations = shortOptionAbbreviations
    ...
    def shortOptionClusters(self, value: Any) -> ShortOptionClusters:
        "Property that decides the approach to short option clusters."
        return ShortOptionClusters(value)
