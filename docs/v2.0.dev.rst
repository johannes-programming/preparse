...
The preparse project allows for preprocessing a list of arguments so that they can be parsed definitively in a later step. 
...
``class preparse.core.OptNaming.OptNaming``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

This class is a subclass of ``datahold.DataNaming[preparse.Nargs]``
with strings as keys and with ``preparse.Nargs`` as values.
It is designed for ``preparse.PreParser.optNaming``.

``class preparse.core.PreParser.PreParser(*, abbr: Optional[Tuning] = Tuning.MINIMIZE, allowsLong: Any = True, allowsShort: Any = True, bundling: Any = Tuning.MAINTAIN, expectsPOSIX: Any = False, optNaming: Any = (), prog: Any = None, reconcilesOrders: Any = True, special: Any = Tuning.MAINTAIN, warn: Callable = str)``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
