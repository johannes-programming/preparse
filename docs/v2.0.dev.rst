...
This project allows to preparse arguments before the main parsing.
...
The project preparse is strongly inspired by
the ``getopt`` and ``getopt_long`` libraries within C.

Here is the implementation of the ``expit`` project (Version 1.0.13)
to illustrate how preparse can be used to modify ``click``.
...
``class preparse.core.Click.Click(parser: preparse.PreParser, cmd: Any = True, ctx: Any = True)``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
``class preparse.core.OptNaming.OptNaming(data: Any = (), /, **kwargs: Any)``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

This class is a subclass of ``datahold.DataNaming[preparse.Nargs]``
with strings as keys and with ``preparse.enums.Nargs.Nargs`` as values.
It is designed for ``preparse.core.PreParser.PreParser.optNaming``.

``class preparse.core.PreParser.PreParser(*, abbr: Any = Tuning.MINIMIZE, allowsLong: Any = True, allowsShort: Any = True, bundling: Any = Tuning.MAINTAIN, expectsPOSIX: Any = False, optNaming: Any = (), prog: Any = None, reconcilesOrders: Any = True, special: Any = Tuning.MAINTAIN, warn: Callable = str)``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
``optNaming: preparse.OptNaming``
"""""""""""""""""""""""""""""""""

This property holds a naming-like object.
Its keys are the options.
Its values specify ``preparse.enums.Nargs.Nargs``.
Options not found within the dictionary
lauch a ``preparse.warners.InvalidOptionWarner.InvalidOptionWarner``
...
Concretely the ``optNaming`` property is changed.
...
This ``preparse.enums.Tuning.Tuning`` property
determines the approach to the special argument ``'--'``.

``toNaming() -> namings.Naming``
""""""""""""""""""""""""""""""""

This method a naming representing the current instance.

``warn: types.FunctionType``
""""""""""""""""""""""""""""

This property holds a function that is called
whenever ``parse_args`` encounters a warning.
...
``preparse.core.PreparseWarning.PreparseWarning(*args: Any)``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
``class preparse.enums.BaseEnum.BaseEnum``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
``class preparse.warners.AmbiguousOptionWarner.AmbiguousOptionWarner``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

``class preparse.warners.DualWarner.DualWarner``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

``class preparse.warners.InvalidOptionWarner.InvalidOptionWarner``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

``class preparse.warners.LongonlyWarner.LongonlyWarner``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

``class preparse.warners.RequiredArgumentWarner.RequiredArgumentWarner``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

``class preparse.warners.UnallowedArgumentWarner.UnallowedArgumentWarner``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

``class preparse.warners.Warner.Warner``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
